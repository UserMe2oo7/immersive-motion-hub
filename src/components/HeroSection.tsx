...
const HeroSection = () => {
  ...
  return <section id="hero" className="section-transition gradient-bg relative overflow-hidden py-0">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        return <div key={`left-${index}`} className="absolute glass-effect p-3 rounded-full animate-float opacity-60 hover:opacity-100 transition-opacity duration-300" style={{
          top: item.top,
          left: item.left,
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        const IconComponent = item.icon;
        return <div key={`right-${index}`} className="absolute glass-effect p-3 rounded-full animate-float opacity-60 hover:opacity-100 transition-opacity duration-300" style={{
          top: item.top,
          right: item.right,
          animationDelay: item.delay,
          animationDuration: '6s'
      ...
      <div className="container mx-auto text-center z-10 relative min-h-screen flex flex-col justify-center px-0">
        <div className="animate-fade-in mx-0 py-[103px]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-slide-in-left animation-delay-600">
            <button onClick={scrollToProjects} className="px-8 py-4 bg-primary hover:bg-primary/80 text-primary-foreground rounded-full font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg">
              Explore My Work
            </button>
